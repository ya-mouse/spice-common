...
//    memset(rangeLimitTableShort, 512, 895, (short)255);
    memset(dec->rangeLimitTable+896, 0, 1280-896);
//    memset(rangeLimitTableShort, 896, 1279, (short)0);
...
//    stride = pixman_image_get_stride(surface);
    ...
    dec->buf = (int32_t *)image->u.ast.data->chunk[0].data;
    dump((void *)dec->buf, 128);
    ...
    printf("### decode_frame(%zd, %x): %dx%d (%dx%d)\n", len, hdr->comp_size, width, height, hdr->src_mode_x, hdr->src_mode_y);
